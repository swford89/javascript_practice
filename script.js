writeRandomQuote = function () {
    let quotes = [
        "Patience is bitter, but its fruit is the sweetest -- Aristotle",
        ...
        "It is easier to find men who will volunteer to die, than to find those who are willing to endure pain with patience -- Julius Caeser"
    ]
...
function copyDate() {
    ...
    let copyrightText = "Copyright Scott Ford ©" + new Date().getFullYear()
